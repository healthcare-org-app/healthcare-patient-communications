"""HTTP routes for patient-communications-service.

Generic CRUD over the `patient_communications` table. Every mutating endpoint publishes a
...
RESOURCE = "patient_communications"
CREATED_EVENT = ""
UPDATED_EVENT = ""
